...
export const MELODIC_MINOR_MODE = 'Melodic Minor';
...
export const SCALES = {
  ...
  [HARMONIC_MINOR_SCALE_MODES]: {
    [HARMONIC_MINOR_SCALE]: <Interval[]>['1', '2', 'b3', '4', '5', 'b6', '7'],
    [AEOLIAN_SHARP_7_MODE]: <Interval[]>['1', 'b2', 'b3', '4', 'b5', 'b6', '7'],
    [LOCRIAN_SHARP_6_MODE]: <Interval[]>['1', 'b2', 'b3', '4', 'b5', '6', 'b7'],
    [IONIAN_SHARP_5_MODE]: <Interval[]>['1', '2', '3', '#4', '5', 'b6', '7'],
    [DORIAN_SHARP_4_MODE]: <Interval[]>['1', '2', 'b3', '#4', '5', '6', 'b7'],
    ...
    [SUPER_LOCRIAN_MODE]: <Interval[]>['1', 'b2', 'b3', 'b4', 'b5', 'b6', 'b7'],
  },
  [MELODIC_MINOR_SCALE_MODES]: {
    [MELODIC_MINOR_SCALE]: <Interval[]>['1', '2', 'b3', '4', '5', '6', '7'],
    [MELODIC_MINOR_MODE]: <Interval[]>['1', '2', 'b3', '4', '5', '6', '7'],
    [DORIAN_FLAT_2_MODE]: <Interval[]>['1', 'b2', 'b3', '4', '5', '6', 'b7'],
    [LYDIAN_AUGMENTED_MODE]: <Interval[]>['1', '2', '3', '#4', '#5', '6', '7'],
    [LYDIAN_DOMINANT_MODE]: <Interval[]>['1', '2', '3', '#4', '5', '6', 'b7'],
    [MIXOLYDIAN_FLAT_6_MODE]: <Interval[]>['1', '2', '3', '4', '5', 'b6', 'b7'],
  ...
  [CHORD_SCALES]: {
    ...
    [HALF_DIMINISHED_SEVENTH_CHORD_SCALE]: <Interval[]>['1', 'b3', 'b5', 'b7'],
