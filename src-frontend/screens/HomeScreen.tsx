  ...
  return (
    <View className=" flex w-full items-center justify-center space-y-4 py-12">
      <View className=" flex w-full flex-row  items-center justify-between  px-8">
        ...
        <View className="flex flex-row space-x-2" key={selectedDifficulty}>
          <Pressable
            onPress={() => setSelectedDifficulty(DrillDifficulty.LOW)}
          ...
          <Pressable
            onPress={() => setSelectedDifficulty(DrillDifficulty.MEDIUM)}
            className="h-full rounded-xl bg-opacity-50 px-4 py-2"
            style={{
              backgroundColor:
            ...
            <Text className="text-xs font-bold  text-white ">Medium</Text>
          </Pressable>
          <Pressable
            onPress={() => setSelectedDifficulty(DrillDifficulty.HIGH)}
            className="h-full rounded-xl bg-opacity-50 px-4 py-2"
            style={{
              backgroundColor:
      ...
      <View className=" flex w-full flex-row  items-center justify-between px-8">
        ...
        <View className="flex flex-row space-x-2" key={selectedExerciseLength}>
          <Pressable
            onPress={() => setSelectedExerciseLength(ExerciseLength.SHORT)}
            className="h-full rounded-xl bg-opacity-50 px-4 py-2"
            style={{
              backgroundColor:
            ...
            <Text className="text-xs font-bold  text-white ">Short</Text>
          </Pressable>
          <Pressable
            onPress={() => setSelectedExerciseLength(ExerciseLength.MEDIUM)}
            className="h-full rounded-xl bg-opacity-50 px-4 py-2"
            style={{
              backgroundColor:
          ...
          <Pressable
            onPress={() => setSelectedExerciseLength(ExerciseLength.LONG)}
            className="h-full rounded-xl bg-opacity-50 px-4 py-2"
            style={{
              backgroundColor:
            ...
            <Text className="text-xs font-bold  text-white ">Long</Text>
          </Pressable>
        </View>
      </View>
      <View className=" flex w-full flex-row  items-center justify-between px-8">
        ...
        <View className="flex flex-row space-x-2" key={selectedDirection}>
          <Pressable
            onPress={() => setSelectedDirection(IntervalDirection.ASC)}
            className="h-full rounded-xl bg-opacity-50 px-4 py-2"
            style={{
              backgroundColor:
            ...
            <Text className="text-xs font-bold  text-white ">Ascending</Text>
          </Pressable>
          <Pressable
            onPress={() => setSelectedDirection(IntervalDirection.DESC)}
            className="h-full rounded-xl bg-opacity-50 px-4 py-2"
            style={{
              backgroundColor:
            ...
            <Text className="text-xs font-bold  text-white ">Descending</Text>
          </Pressable>
          <Pressable
            onPress={() => setSelectedDirection(IntervalDirection.RANDOM)}
            className="h-full rounded-xl bg-opacity-50 px-4 py-2"
            style={{
              backgroundColor:
            ...
            <Text className="text-xs font-bold  text-white ">Random</Text>
          </Pressable>
        </View>
      </View>
    </View>
